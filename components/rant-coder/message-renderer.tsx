...
const CodeProjectPartWrapper = ({
  ...
  return (
    <div
      className={`my-6 rounded-lg border bg-white dark:bg-gray-900 ${
        className || ""
      }`}
      {...props}
    >
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <span className="rounded bg-gray-100 px-2 py-1 text-gray-500 text-sm dark:bg-gray-700">
            v1
          </span>
          <svg
